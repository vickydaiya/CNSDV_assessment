...
# write.xlsx(data_list, file = "d",headerStyle = createStyle(textDecoration = "Bold"), colWidths = "auto")

tsv_dir <- paste0(getwd(),"/Azimuth local TSVs/")
tsv_files <- list.files(tsv_dir)
...
names(data_list) = tsv_files
write.xlsx(data_list, file = "Azimuth_local_analysis.xlsx",headerStyle = createStyle(textDecoration = "Bold"), colWidths = "auto")